...
// Pas de contract attaque sur celui-ci.
// Une grosse faille fonctionnelle cependant : 
// le base price permettant de calculer le prix d'un object est tronqué sur la division